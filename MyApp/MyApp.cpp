...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_TRAYICON:
        ...
        else if (lParam == WM_RBUTTONUP) // AGGIUNTO: click destro
        {
            ...
            AppendMenu(hTrayMenu, MF_SEPARATOR, 0, NULL);
            AppendMenu(hTrayMenu, MF_STRING, IDM_FILE_EXIT, L"Esci da MyApp");
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    hMutex = CreateMutexW(NULL, TRUE, L"MyApp_Mutex_SingleInstance");
    ...
    lstrcpy(nid.szTip, L"MyApp - Doppio-click per ripristinare");
    ...
    // Pulsanti
    CreateWindowEx(0, L"BUTTON", L"BUTTON TEST",
        WS_CHILD | WS_VISIBLE,
        50, 50, 250, 30,
    ...
    SetWindowTextW(hSwapInfo, L"TESTO DI PROVA\r\nMULTILINEA");
